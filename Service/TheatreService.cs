...
namespace BookMyShow.Service
{
    public class TheatreService:ITheatreService
    {
        ...
        {
            return (_context.Execute("UPDATE Theatre SET Name=@Name,Location=@Location,CreatedDate=@CreatedDate,UpdatedDate=@UpdatedDate,DeletedDate=@DeletedDate,IsDeleted=@IsDeleted where Id=@Id",theatre)==1);
        ...
        {
            var query = "SELECT t.Id,t.Name,t.Location,t.CreatedDate,t.UpdatedDate,t.DeletedDate,t.IsDeleted FROM Theatre t " +
