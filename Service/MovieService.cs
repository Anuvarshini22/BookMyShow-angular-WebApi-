...
namespace BookMyShow.Service
{
    public class MovieService: IMovieService
    {
        ...
        {
          return  (_context.Execute("UPDATE Movie SET Title=@Title,Language=@Language,Genre=@Genre,ImageUrl=@ImageUrl,Description=@Description,Price=@Price,CreatedDate=@CreatedDate,UpdatedDate=@UpdatedDate,DeletedDate=@DeletedDate,IsDeleted=@IsDeleted where Id=@Id",movie)==1);
