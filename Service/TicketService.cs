...
namespace BookMyShow.Service
{
    public class TicketService : ITicketService
    {
        ...
        {
           return (_context.Execute("UPDATE Theatre SET (UserName=@UserName,NumberOfSeats=@NumberOfSeats,ShowId=@ShowId,TheatreId=@TheatreId,MovieId=@MovieId,CreatedDate=@CreatedDate,UpdatedDate=@UpdatedDate,DeletedDate=@DeletedDate,IsDeleted=@IsDeleted where Id=@Id", ticket)==1);
