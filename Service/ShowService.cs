...
namespace BookMyShow.Service
{
    public class ShowService:IShowService
    {
        ...
        public IEnumerable<ShowViewModel> GetShows()
            ...
            {
                return (_context.Execute("INSERT INTO Show(Name,StartTime,EndTime,TheatreId,MovieId,Capacity,SeatsAvailable,CreatedDate,UpdatedDate,DeletedDate,IsDeleted)VALUES(@Name,@StartTime,@EndTime,@TheatreId,@MovieId,@Capacity,@SeatsAvailable,@CreatedDate,@UpdatedDate,@DeletedDate,@IsDeleted)", new { Name = show.Name, StartTime = show.StartTime, EndTime = show.EndTime, TheatreId = show.TheatreId , MovieId=show.MovieId, Capacity=show.Capacity, SeatsAvailable=show.SeatsAvailable,CreatedDate=show.CreatedDate, UpdatedDate=show.UpdatedDate, DeletedDate=show.DeletedDate, IsDeleted=show.IsDeleted })==1);
            }
        ...
        {
            return (_context.Execute("UPDATE Show SET Name=@Name,StartTime=@StartTime,EndTime=@EndTime,TheatreId=@TheatreId,MovieId=@MovieId,Capacity=@Capacity,CreatedDate=@CreatedDate,UpdatedDate=@UpdatedDate,DeletedDate=@DeletedDate,IsDeleted=@IsDeleted where Id=@Id",show)==1);
